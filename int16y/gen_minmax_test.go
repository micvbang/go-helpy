...
func TestMax(t *testing.T) {
	tests := map[string]struct {
		...
		"in order":      {input: []int16{1, 2}, expected: 2},
		"reverse order": {input: []int16{5, 2}, expected: 5},
		"3 arguments":   {input: []int16{10, 5, 15}, expected: 15},
		"4 arguments":   {input: []int16{1, 122, 100}, expected: 122},
		"10 arguments":  {input: []int16{17, 25, 1, 0, 101, 125, 42, 13, 37, 69}, expected: 125},

		"one negative":          {input: []int16{-5, 10}, expected: 10},
		"both negative":         {input: []int16{-5, -100}, expected: -5},
		"10 arguments negative": {input: []int16{17, 25, -1, 0, -101, 127, 42, -13, 37, 69}, expected: 127},
	}
